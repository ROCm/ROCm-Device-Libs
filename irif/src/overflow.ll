...
define zeroext i1 @__llvm_sadd_with_overflow_i32(i32, i32, i32 addrspace(0)* nocapture) #0 {
  %4 = call {i32, i1} @llvm.sadd.with.overflow.i32(i32 %0, i32 %1)
  %5 = extractvalue {i32, i1} %4, 0
  store i32 %5, i32 addrspace(0)* %2, align 4
  %6 = extractvalue {i32, i1} %4, 1
  ret i1 %6
}

define zeroext i1 @__llvm_uadd_with_overflow_i32(i32, i32, i32 addrspace(0)* nocapture) #0 {
...
define zeroext i1 @__llvm_sadd_with_overflow_i64(i64, i64, i64 addrspace(0)* nocapture) #0 {
  %4 = call {i64, i1} @llvm.sadd.with.overflow.i64(i64 %0, i64 %1)
  %5 = extractvalue {i64, i1} %4, 0
  store i64 %5, i64 addrspace(0)* %2, align 4
  %6 = extractvalue {i64, i1} %4, 1
  ret i1 %6
}

define zeroext i1 @__llvm_uadd_with_overflow_i64(i64, i64, i64 addrspace(0)* nocapture) #0 {
...
define zeroext i1 @__llvm_ssub_with_overflow_i32(i32, i32, i32 addrspace(0)* nocapture) #0 {
...
define zeroext i1 @__llvm_usub_with_overflow_i32(i32, i32, i32 addrspace(0)* nocapture) #0 {
...
define zeroext i1 @__llvm_ssub_with_overflow_i64(i64, i64, i64 addrspace(0)* nocapture) #0 {
...
define zeroext i1 @__llvm_usub_with_overflow_i64(i64, i64, i64 addrspace(0)* nocapture) #0 {
...
define zeroext i1 @__llvm_smul_with_overflow_i32(i32, i32, i32 addrspace(0)* nocapture) #0 {
...
define zeroext i1 @__llvm_umul_with_overflow_i32(i32, i32, i32 addrspace(0)* nocapture) #0 {
...
define zeroext i1 @__llvm_smul_with_overflow_i64(i64, i64, i64 addrspace(0)* nocapture) #0 {
...
define zeroext i1 @__llvm_umul_with_overflow_i64(i64, i64, i64 addrspace(0)* nocapture) #0 {
